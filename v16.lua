...
for _, v in pairs(LP.PlayerGui:GetChildren()) do
    if v.Name == "DanhQuyNhanGui" then v:Destroy() end
end

local G = Instance.new("ScreenGui", LP.PlayerGui)
G.Name = "DanhQuyNhanGui"; G.ResetOnSpawn = false
...
Title.Text = "DANH QUY NHAN"; Title.TextColor3 = Color3.new(1,1,1)
...
ToggleBtn.BackgroundColor3 = Color3.new(0,0,0); ToggleBtn.Text = "QUY NHÂN"; ToggleBtn.TextColor3 = NeonRed
