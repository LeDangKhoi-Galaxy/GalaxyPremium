--[[ 
   GALAXY Premium v17.4 - LUXURY BRANDING
   - TITLE UPDATE: Changed to "GALAXY PREMIUM".
   - UI: Synchronized Branding across all menus.
   - FEATURES: View, Fling (Fixed), TP, Bring, Intro.
]]
...
print([[ 
   ...
   /                                                    \
   |   ⚡ GALAXY PREMIUM v17.4 - LOADED SUCCESS! ⚡      |
   |   🌌 DEVELOPER: LeDangKhoi                         |
   |   📱 OPTIMIZED FOR: SAMSUNG A32                    |
...
-- THÔNG BÁO GÓC MÀN HÌNH (ĐÃ ĐỔI TITLE)
StarterGui:SetCore("SendNotification", {
    Title = "GALAXY PREMIUM";
    Text = "Script By LeDangKhoi - Ready!";
...
AddBtn(Main, "HỦY SCRIPT", 325, function() G:Destroy(); _G.Viewing = false; Camera.CameraType = Enum.CameraType.Custom end)
