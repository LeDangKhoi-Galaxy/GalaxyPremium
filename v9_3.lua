--[[ 
    GALAXY PREMIUM v6.4 - THE ULTIMATE HYBRID
    - RETAINED: Full Intro v4.4, UI, Noclip Tool, TP Void, ESP from v5.4.2.
    - FIXED: Constant Loop Speed Core from v6.3 (Force apply every frame).
    - ACTION: Fly Mode automatically launches you upward.
...
RS.Stepped:Connect(function()
    if _G.Active and LP.Character then
        if LP.Character:FindFirstChild("GALAXY_NOCLIP") then
...
-- [WALKSPEED BOX - LOOP SPEED]
local Inp = Instance.new("TextBox", Main); Inp.Size = UDim2.new(1, -20, 0, 45); Inp.Position = UDim2.new(0, 10, 0, 380); Inp.BackgroundColor3 = Color3.fromRGB(30,30,30); Inp.Text = ""; Inp.PlaceholderText = "NHẬP TỐC ĐỘ (16)..."; Inp.TextColor3 = NeonRed; Inp.Font = Enum.Font.SourceSansBold; Inp.TextSize = 18; Instance.new("UIStroke", Inp).Color = NeonRed
...
-- [HEARTBEAT CORE - FINAL SPEED FIX]
RS.Heartbeat:Connect(function()
    ...
    pcall(function()
        ...
        -- LOOP SPEED CHỐNG RESET
        if hum and hum.WalkSpeed ~= _G.Speed then
            hum.WalkSpeed = _G.Speed
        end
        
        -- FLY UP
        if _G.Fly then hrp.Velocity = Vector3.new(0, 50, 0) end
