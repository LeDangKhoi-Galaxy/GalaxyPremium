--[[ 
   GALAXY PREMIUM v5.5.6.3 - ABSOLUTE TERMINATION
   - FIXED: "HỦY SCRIPT" tắt toàn bộ chức năng, vòng lặp và dọn dẹp Workspace.
   - ADDED: Reset WalkSpeed và xóa ESP Tags ngay khi thoát.
...
local function AbsoluteCleanUp()
    ...
    -- 2. Xóa ESP Tags trên toàn bộ người chơi
...
G.Name = "Galaxy_Ultimate"; G.ResetOnSpawn = false
...
local function StartIntro()
    ...
    local BoxStroke = Instance.new("UIStroke", IntroBox); BoxStroke.Color = NeonRed; BoxStroke.Thickness = 2
    local IntroText = Instance.new("TextLabel", IntroBox); IntroText.Size = UDim2.new(1, 0, 1, 0); IntroText.BackgroundTransparency = 1; IntroText.Text = "GALAXY Premium By LeDangKhoi"; IntroText.TextColor3 = NeonRed; IntroText.Font = Enum.Font.SourceSansBold; IntroText.TextSize = 25
...
-- [NÚT HỦY SCRIPT - FULL TERMINATION]
...
task.spawn(function() ApplyFFlags(); DisableShake(); StartIntro(); GiveNoclip(); Main.Visible = true; ToggleBtn.Visible = true end)
