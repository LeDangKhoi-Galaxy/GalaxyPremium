...
-- BIẾN HỆ THỐNG
_G.Active = true
_G.TargetName = ""; _G.Speed = 16; _G.Fly = false; _G.AutoBlock = false; 
_G.Aim = false; _G.ESP = false; _G.LoopTP = false; _G.Bring = false; 
_G.VoidActive = false; _G.Noclip = false
...
-- [CHỨC NĂNG NOCLIP & TOOL]
local function GiveNoclipTool()
    if not LP.Backpack:FindFirstChild("Noclip") then
        ...
        Tool.Activated:Connect(function()
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
                ...
                Text = "Noclip: " .. (_G.Noclip and "BẬT" or "TẮT"),
                Duration = 2
            })
        end)
    end
                    ...
                    if anim then
                        for _, t in pairs(anim:GetPlayingAnimationTracks()) do
                            if t.IsPlaying and t.Speed > 1.1 then
                                VIM:SendKeyEvent(true, Enum.KeyCode.F, false, game); blockTick = tick()
                                break
                            end
                        end
                    end
